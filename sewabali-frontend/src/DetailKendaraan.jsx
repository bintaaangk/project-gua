...
// (Disimpan sama seperti sebelumnya, dipersingkat di sini agar fokus ke komponen)
const MOCK_DATA = {
  1: {
    id: 1,
    ...
    kapasitas: 7,
    bahan_bakar: "Bensin",
    deskripsi: "Nikmati kenyamanan premium dengan Innova Zenix. Cocok untuk perjalanan keluarga besar di Bali dengan interior mewah.",
    perental: { nama: "Bli Komang Jaya", avatar_url: "https://placehold.co/100x100/007bff/FFFFFF?text=BK", alamat: "Jl. Raya Kuta No.88, Badung", lokasi_map: "Kuta, Bali", no_hp: "6281234567890" }
  },
...
function DetailKendaraan() {
  ...
  useEffect(() => {
    ...
    // Fallback ke ID 1 jika data tidak ada di mock
      ...
      <div className="detail-scroll-content">
        ...
        <div className="spec-section">
            ...
            <div className="spec-grid">
                ...
                <SpecIcon 
                    title="Kapasitas" 
                    value={`${kendaraan.kapasitas} Orang`}
        ...
        <div className="desc-section">
            ...
            <p className="desc-text">{kendaraan.deskripsi}</p>
        </div>
        ...
        <div className="renter-section">
            ...
            <div className="renter-card">
                <img src={kendaraan.perental.avatar_url} alt="Avatar" className="renter-avatar" />
                <div className="renter-info">
                    <h4 className="renter-name">{kendaraan.perental.nama}</h4>
                    <p className="renter-loc">{kendaraan.perental.alamat}</p>
                </div>
